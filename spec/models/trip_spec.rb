...
describe Trip do
  before do
    @trip = Trip.new(trip_name: "First trip", description: "Bla")
    @wroclaw = Place.new(latitude: 12.34, longitude: 56.78)
    @berlin = Place.new(latitude: 56.12666, longitude: 11.111)
    @poznan = Place.new(latitude: 98.76, longitude: 93.543)
  end
  ...
  pending "can be created with many places" do
    places = 8.times.with_object([]) { |nr, obj| obj << Place.new(latitude: rand(10000) / 100.0, longitude: rand(10000) / 100.0) }
